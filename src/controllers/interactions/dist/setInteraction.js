...
function setInteraction(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, userId, productId, type, score, interaction, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, userId = _a.userId, productId = _a.productId, type = _a.type, score = _a.score;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    interaction = new interactionModel_1.Interaction({ userId: userId, productId: productId, type: type, score: score });
